...
import com.aok.core.Filter;
import com.aok.core.Order;
import com.aok.core.Order.Direction;
...
public class Pageable implements Serializable {
	...
	public int getStartRow() {
		return this.pageNumber>=1?(this.pageNumber-1)*this.pageSize:0;
	}
